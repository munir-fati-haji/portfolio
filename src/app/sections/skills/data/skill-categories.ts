...
export const SKILL_CATEGORIES: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Material Theming', icon: 'format_color_fill', level: 'Strong' },
      { name: 'Material Icon Registry', icon: 'interests', level: 'Strong' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Stylelint', icon: 'rule_settings', level: 'Strong' },
